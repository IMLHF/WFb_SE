...
def train():
  ...
  with g.as_default():
    ...
    for epoch in range(PARAM.start_epoch, PARAM.max_epochs):
      ...
      rel_impr = np.abs(mag_loss_prev - val_mag_loss) / mag_loss_prev
      # Accept or reject new parameters
      msg = ""
      if val_mag_loss < mag_loss_prev:
        reject_num = 0
...
if __name__ == '__main__':
  ...
  # python3 1_alter_train.py 1 2>&1 | tee exp/rnn_speech_enhancement/nnet_C00X_train_full.log
